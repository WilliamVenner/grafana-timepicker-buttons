...
/***/ "../node_modules/css-loader/dist/cjs.js?!../node_modules/postcss-loader/src/index.js?!../node_modules/sass-loader/lib/loader.js!./css/TimepickerButton.css":
/*!**************************************************************************************************************************************************************************!*\
  !*** ../node_modules/css-loader/dist/cjs.js??ref--8-1!../node_modules/postcss-loader/src??ref--8-2!../node_modules/sass-loader/lib/loader.js!./css/TimepickerButton.css ***!
  \**************************************************************************************************************************************************************************/
...
// Module
exports.push([module.i, ".timepicker-btn {\n  display: block;\n  width: 100%;\n  height: auto;\n  padding-top: 5.5px;\n  padding-bottom: 5.5px; }\n\n.timepicker-btn:not(:last-child) {\n  margin-bottom: 10px; }\n\n.timepicker-btn > .error {\n  font-weight: bold; }\n\n.timepicker-btn > .error:not(:last-child) {\n  margin-bottom: .25rem; }\n", "",{"version":3,"sources":["TimepickerButton.css"],"names":[],"mappings":"AAAA;EACE,cAAc;EACd,WAAW;EACX,YAAY;EACZ,kBAAkB;EAClB,qBAAqB,EAAE;;AAEzB;EACE,mBAAmB,EAAE;;AAEvB;EACE,iBAAiB,EAAE;;AAErB;EACE,qBAAqB,EAAE","file":"TimepickerButton.css","sourcesContent":[".timepicker-btn {\n  display: block;\n  width: 100%;\n  height: auto;\n  padding-top: 5.5px;\n  padding-bottom: 5.5px; }\n\n.timepicker-btn:not(:last-child) {\n  margin-bottom: 10px; }\n\n.timepicker-btn > .error {\n  font-weight: bold; }\n\n.timepicker-btn > .error:not(:last-child) {\n  margin-bottom: .25rem; }\n"]}]);
// Exports
...
/*!************************************************************!*\
  !*** ../node_modules/grafana-plugin-support/dist/index.js ***!
  \************************************************************/
/*! exports provided: FieldSelectEditor, getFormattedDisplayValue, measureText, toTimeField, standardOptionsCompat, hasCapability */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!***********************************************************************!*\
  !*** ../node_modules/grafana-plugin-support/dist/utils/capability.js ***!
  \***********************************************************************/
/*! exports provided: hasCapability, standardOptionsCompat */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var hasCapability = function (capability) {
    var version = _grafana_runtime__WEBPACK_IMPORTED_MODULE_0__["config"].buildInfo.version;
    switch (capability) {
        case "color-scheme":
            return Object(semver__WEBPACK_IMPORTED_MODULE_1__["gte"])(version, "7.3.0");
        case "standard-options-object":
            return Object(semver__WEBPACK_IMPORTED_MODULE_1__["gte"])(version, "7.4.0");
        default:
            return false;
    }
};
...
var standardOptionsCompat = function (options) {
    ...
    return hasCapability("standard-options-object")
        ? options.reduce(function (acc, curr) {
            acc[curr] = {};
            return acc;
        }, init)
        : options;
...
var toTimeField = function (field, timeZone) {
    if ((field === null || field === void 0 ? void 0 : field.type) === _grafana_data__WEBPACK_IMPORTED_MODULE_1__["FieldType"].number) {
        ...
        tmp.display = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_1__["getDisplayProcessor"])({ field: tmp });
        return tmp;
    }
...
/*!******************************************************************!*\
  !*** ../node_modules/grafana-plugin-support/dist/utils/index.js ***!
  \******************************************************************/
/*! exports provided: getFormattedDisplayValue, measureText, toTimeField, standardOptionsCompat, hasCapability */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _format__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./format */ "../node_modules/grafana-plugin-support/dist/utils/format.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "getFormattedDisplayValue", function() { return _format__WEBPACK_IMPORTED_MODULE_0__["getFormattedDisplayValue"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "measureText", function() { return _format__WEBPACK_IMPORTED_MODULE_0__["measureText"]; });
...
/* harmony import */ var _capability__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./capability */ "../node_modules/grafana-plugin-support/dist/utils/capability.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "standardOptionsCompat", function() { return _capability__WEBPACK_IMPORTED_MODULE_2__["standardOptionsCompat"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "hasCapability", function() { return _capability__WEBPACK_IMPORTED_MODULE_2__["hasCapability"]; });
...
/* harmony import */ var _TimepickerSelect__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./TimepickerSelect */ "./TimepickerSelect.tsx");
/* harmony import */ var _TimepickerButton__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./TimepickerButton */ "./TimepickerButton.tsx");
...
var Panel = function Panel(_a) {
  var options = _a.options,
      ...
      width = _a.width,
      height = _a.height;
  var styles = getStyles(); // Convert data retrieved from datasource into a data structure we can process into <button> elements

  var buttons = [];
  data.series.forEach(function (series) {
    var _a, _b, _c, _d;

    var timeVals = series.fields[0].values.toArray(); // Create all selectable values, i.e. all frames in the data query response.

    for (var i = 0; i < timeVals.length; i++) {
      var button = {
        text: (_a = series.fields.find(function (field) {
          return field.name === options.buttonTextOption;
        })) === null || _a === void 0 ? void 0 : _a.values.get(i),
        time_from: (_b = series.fields.find(function (field) {
          return field.name === options.timeFromOption;
        })) === null || _b === void 0 ? void 0 : _b.values.get(i),
        time_to: (_c = series.fields.find(function (field) {
          return field.name === options.timeToOption;
        })) === null || _c === void 0 ? void 0 : _c.values.get(i),
        errors: []
      }; // Sanitize primary

      if (typeof options.primaryFieldOption !== 'undefined' && typeof options.primaryFieldValueOption !== 'undefined') {
        var primary = (_d = series.fields.find(function (field) {
          return field.name === options.primaryFieldOption;
        })) === null || _d === void 0 ? void 0 : _d.values.get(i);
      ...
      var ds = Object(_grafana_data__WEBPACK_IMPORTED_MODULE_3__["dateTimeParse"])(button.time_from);
      console.log(ds);
      console.log(ds.isValid);
      ...
      if (typeof button.time_from === 'undefined' || button.time_from === null) {
        ...
        if (isNaN(button.time_from)) {
          ...
          button.text = new Date(Object(_utils__WEBPACK_IMPORTED_MODULE_5__["getEpochWithMillis"])(button.time_from)).toLocaleString();
        } else {
  ...
  }, options.displayStyle === 'dropdown' && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_TimepickerSelect__WEBPACK_IMPORTED_MODULE_6__["TimepickerSelect"], {
    timepickerData: buttons
  }), options.displayStyle === 'button' && !options.displayButtonsHorizontal && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["FullWidthButtonContainer"], null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["VerticalGroup"], {
    spacing: 'sm'
  }, buttonFactory(buttons))), options.displayStyle === 'button' && options.displayButtonsHorizontal && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["HorizontalGroup"], {
    spacing: 'sm',
    wrap: true
  }, buttonFactory(buttons))));
};

function buttonFactory(buttons) {
  return buttons.map(function (button) {
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_TimepickerButton__WEBPACK_IMPORTED_MODULE_7__["TimepickerButton"], {
      text: button.text,
...
/***/ "./TimepickerButton.tsx":
/*!******************************!*\
  !*** ./TimepickerButton.tsx ***!
  \******************************/
/*! exports provided: TimepickerButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TimepickerButton", function() { return TimepickerButton; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _css_TimepickerButton_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./css/TimepickerButton.css */ "./css/TimepickerButton.css");
/* harmony import */ var _css_TimepickerButton_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_css_TimepickerButton_css__WEBPACK_IMPORTED_MODULE_2__);
...
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(TimepickerButton, _super);
  ...
  TimepickerButton.prototype.handleClick = function () {
    if (this.props.errors.length === 0) {
      Object(_utils__WEBPACK_IMPORTED_MODULE_3__["getQueryMapo"])(this.props.time_from, this.props.time_to);
    }
  };

  TimepickerButton.prototype.render = function () {
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["Button"], {
    ...
    }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, getTitle(this.props)), getErrors(this.props.errors));
  };
...
function getTitle(props) {
  ...
  var timeFrom = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["getPrettyDate"])(props.time_from);
  return timeFrom !== 'now' ? timeFrom : 'Error:';
}

function getErrors(errors) {
  if (errors.length > 0) {
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, ' ' + errors.join());
  }
...
/***/ "./TimepickerSelect.tsx":
/*!******************************!*\
  !*** ./TimepickerSelect.tsx ***!
  \******************************/
/*! exports provided: TimepickerSelect */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TimepickerSelect", function() { return TimepickerSelect; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _css_TimepickerButton_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./css/TimepickerButton.css */ "./css/TimepickerButton.css");
...
/** @class */
function (_super) {
  Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(TimepickerSelect, _super);

  function TimepickerSelect() {
    var _this = _super !== null && _super.apply(this, arguments) || this;

    _this.handleChange = function (selectedOption) {
      var selected = _this.props.timepickerData[selectedOption.value];
      Object(_utils__WEBPACK_IMPORTED_MODULE_3__["getQueryMapo"])(selected.time_from, selected.time_to);
    };
  ...
  TimepickerSelect.prototype.render = function () {
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["Select"], {
      onChange: this.handleChange,
      options: this.props.timepickerData.map(function (option, index) {
        return {
          label: option.errors.length > 0 ? 'Error' : option.text || Object(_utils__WEBPACK_IMPORTED_MODULE_3__["getPrettyDate"])(option.time_from),
          value: index,
          icon: 'plus-square',
          description: option.errors.join() || Object(_utils__WEBPACK_IMPORTED_MODULE_3__["getPrettyDate"])(option.time_from) + ' to ' + Object(_utils__WEBPACK_IMPORTED_MODULE_3__["getPrettyDate"])(option.time_to)
        };
      })
    });
  };
...
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js??ref--8-1!../../node_modules/postcss-loader/src??ref--8-2!../../node_modules/sass-loader/lib/loader.js!./TimepickerButton.css */ "../node_modules/css-loader/dist/cjs.js?!../node_modules/postcss-loader/src/index.js?!../node_modules/sass-loader/lib/loader.js!./css/TimepickerButton.css");
...
/* harmony import */ var _Panel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Panel */ "./Panel.tsx");



var plugin = new _grafana_data__WEBPACK_IMPORTED_MODULE_0__["PanelPlugin"](_Panel__WEBPACK_IMPORTED_MODULE_2__["Panel"]).setPanelOptions(function (builder) {
  return builder.addSelect({
    ...
    showIf: function showIf(config) {
      return config.displayStyle === 'button';
    }
  }).addCustomEditor({
    id: 'timeFromOption',
    path: 'timeFromOption',
    ...
    editor: grafana_plugin_support__WEBPACK_IMPORTED_MODULE_1__["FieldSelectEditor"],
    settings: {
      filterByType: [_grafana_data__WEBPACK_IMPORTED_MODULE_0__["FieldType"].number]
    }
  }).addCustomEditor({
    id: 'timeToOption',
    path: 'timeToOption',
    ...
    category: ['Field Mapping'],
    showIf: function showIf(config) {
      return typeof config.primaryFieldOption !== 'undefined';
    }
  });
});
...
/*!******************!*\
  !*** ./utils.ts ***!
  \******************/
/*! exports provided: getEpochWithMillis, getQueryMap, getQueryMapo, getPrettyDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getEpochWithMillis", function() { return getEpochWithMillis; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getQueryMap", function() { return getQueryMap; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getQueryMapo", function() { return getQueryMapo; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPrettyDate", function() { return getPrettyDate; });
/* harmony import */ var _grafana_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @grafana/data */ "@grafana/data");
/* harmony import */ var _grafana_data__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_grafana_data__WEBPACK_IMPORTED_MODULE_0__);
...
var getEpochWithMillis = function getEpochWithMillis(time) {
  return time < 100000000000 ? time * 1000 : time;
};
var getQueryMap = function getQueryMap(time_from, time_to) {
  var queryMap = {
    from: getEpochWithMillis(time_from),
    to: 'now'
  };
...
function getQueryMapo(time_from, time_to) {
  var queryMap = {
    from: getEpochWithMillis(time_from),
    to: 'now'
  };
  ...
  Object(_grafana_runtime__WEBPACK_IMPORTED_MODULE_1__["getLocationSrv"])().update({
    partial: true,
    replace: true,
    query: queryMap
  });
}
var getPrettyDate = function getPrettyDate(time) {
  if (typeof time !== 'undefined' && time !== null && !isNaN(time)) {
    return Object(_grafana_data__WEBPACK_IMPORTED_MODULE_0__["dateTimeFormatWithAbbrevation"])(getEpochWithMillis(time));
  }
